               ...
               if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1){
                        ...
                        db.addUser(json_user.getString(KEY_FIRSTNAME),json_user.getString(KEY_LASTNAME),json_user.getString(KEY_EMAIL),json_user.getString(KEY_USERNAME),json_user.getString(KEY_UID),json_user.getString(KEY_CREATED_AT),
                        		json_user.getString(KEY_WEIGHT_GENDER), json_user.getString(KEY_WEIGHT_SMOKER), json_user.getString(KEY_PREF_GENDER),
                        		json_user.getString(KEY_PREF_SMOKER));
                       /**
                        *If JSON array details are stored in SQlite it launches the User Panel.
                        **/
                        Intent upanel = new Intent(getApplicationContext(), MapActivity.class);
                        
                        String uid = json_user.getString("uid");
                        upanel.putExtra("uid",uid);
